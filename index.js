...
const utils = {
    ...
    handleEventMinutes: function () {
        ...
        inputNumbers.forEach((inputNumber) => inputNumber.addEventListener('input', (e) => {
...
const page = {
    ...
    <i class="fas fa-times-circle deleteBtn" data-pic=${exo.pic} ></i>
        ...
        utils.pageContent("Parametrage <i id='reboot' class='fas fa-undo'></i> ", "<ul>" + mapArray + "</ul>", '<button id="start"> Commencer <i class="far fa-play-circle"></i></button>');
    ...
    routine: function () {
        utils.pageContent("Routine", "Exercice avec chronos", null);
    },
    finish: function () {
        utils.pageContent("C'est terminé !", "<button id='start'>Recommencer</button>", "<button id='reboot' class='btn-reboot' >Réinitialiser <i class='fas fa-times-circle'></i></button>");
    }
};
page.lobby();
